...
def save_thesis_ids():
    ...
    with open( "./cache/thesis_ids.p", "wb" ) as outfile:
        pickle.dump(result, outfile)
        
def load_thesis_ids():
    with open( "./cache/thesis_ids.p", "rb" ) as infile:
...
def save_descriptors():
    ...
    with open( "./cache/descriptors.p", "wb" ) as outfile:
        pickle.dump(result, outfile)
        
def load_descriptors():
    with open( "./cache/descriptors.p", "rb" ) as infile:
        result = pickle.load(infile)
    return result
...
def save_name_genders():
    ...
    with open( "./cache/genders.p", "wb" ) as outfile:
        pickle.dump(result, outfile) 
        
    with open( "./cache/badnames.p", "wb" ) as outfile:
        pickle.dump(bad_names, outfile) 
    
    return bad_names
       
def load_genders():
    with open( "./cache/genders.p", "rb" ) as infile:
        result = pickle.load(infile)
    return result
...
def check_similar_names():
    ...
    with open( "./cache/repeated.p", "wb" ) as outfile:
