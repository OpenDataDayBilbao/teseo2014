...
#    print 'Writing file'
#    nx.write_gexf(G, '../website/static/data/processed_data/panel_relations_filtered.gexf')
#
#    #create the social network for the thematic areas
#    G = build_area_relations()
#    print 'Writing file'
#    nx.write_gexf(G, '../website/static/data/processed_data/area_relations.gexf')
#
...
#    pp.pprint(unis)
#    json.dump(unis, open('../website/static/data/processed_data/universities_temporal.json', 'w'), indent = 4)
#
...
#    pp.pprint(regions)
#    json.dump(regions, open('../website/static/data/processed_data/regions_temporal.json', 'w'), indent = 4)
#
...
#    pp.pprint(areas)
#    json.dump(areas, open('../website/static/data/processed_data/areas_temporal.json', 'w'), indent = 4)
#
...
#    json.dump(genders_total, open('../website/static/data/processed_data/genders_total.json', 'w'), indent = 4)
#
...
#    json.dump(genders_percentage, open('../website/static/data/processed_data/genders_percentage.json', 'w'), indent = 4)
#
...
#    json.dump(genders_area_total, open('../website/static/data/processed_data/genders_area_total.json', 'w'), indent = 4)
#
...
#    json.dump(primary_areas, open('../website/static/data/processed_data/first_level_areas_temporal.json', 'w'), indent = 4)
#
...
#    json.dump(panel_gender, open('../website/static/data/processed_data/gender_panel_temporal.json', 'w'), indent = 4)
#
...
#    json.dump(meta_area_gender, open('../website/static/data/processed_data/gender_first_level_areas_temporal.json', 'w'), indent = 4)
    ...
    json.dump(month_distribution, open('../website/static/data/processed_data/month_distribution.json', 'w'), indent = 4)
